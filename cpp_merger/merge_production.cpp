...
int main(int argc, char **argv) {
  ...
  for (const auto &raw_file_str : raw_files) {
    ...
    if (merge_beam) {
      ...
      t_beam->SetBranchAddress("act1_time_l", &act1_l_time);
      t_beam->SetBranchAddress("act1_time_r", &act1_r_time);
      t_beam->SetBranchAddress("act2_time_l", &act2_l_time);
      t_beam->SetBranchAddress("act2_time_r", &act2_r_time);
      t_beam->SetBranchAddress("act3_time_l", &act3_l_time);
      t_beam->SetBranchAddress("act3_time_r", &act3_r_time);
      t_beam->SetBranchAddress("act4_time_l", &act4_l_time);
      t_beam->SetBranchAddress("act4_time_r", &act4_r_time);
      t_beam->SetBranchAddress("act5_time_l", &act5_l_time);
      t_beam->SetBranchAddress("act5_time_r", &act5_r_time);
